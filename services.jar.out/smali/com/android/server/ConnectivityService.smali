...
.field private static final EPDG_ERROR_NONE:I = 0x0

.field private static final EPDG_FACOTRY_HIGH_SCORE:I = 0x50

.field private static final EPDG_IP_BAD_ADDRESS:I = 0x7cf

.field private static final EPDG_POLICY_DENY:I = 0x7d6

.field private static final EPDG_POLICY_NONE:I = 0x7d7
...
.field private static final MOBILE_AGENT_SCORE:I = 0x32
...
.method private getFailureCause(Landroid/net/NetworkInfo;)I
    .locals 4
...
.method private handleEpdgDisconnect(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    .line 5096
    .local v0, "cap":Landroid/net/NetworkCapabilities;
    if-eqz v0, :cond_5
    ...
    invoke-direct {p0, v5, v8, v9}, Lcom/android/server/ConnectivityService;->updateFailureCause(ILandroid/net/NetworkCapabilities;Landroid/net/NetworkInfo;)V
    ...
    invoke-direct {p0, v8}, Lcom/android/server/ConnectivityService;->getFailureCause(Landroid/net/NetworkInfo;)I
    ...
    invoke-direct {p0, v12, v8}, Lcom/android/server/ConnectivityService;->evalHandoverRequest(ILjava/lang/String;)Z
...
.method private handleHandoverExpired()V
    ...
    invoke-direct {p0, v5, v0}, Lcom/android/server/ConnectivityService;->evalHandoverRequest(ILjava/lang/String;)Z
...
.method private handlePdnRetry(I)V
    ...
    invoke-virtual {v7, v13, v8, v10, v5}, Lcom/android/internal/util/AsyncChannel;->sendMessage(IIILjava/lang/Object;)V
    ...
    invoke-virtual {v7, v13, v3, v10, v5}, Lcom/android/internal/util/AsyncChannel;->sendMessage(IIILjava/lang/Object;)V
...
.method private teardownUnneededNetwork(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    const-string v5, "Dead network still had at least "
    ...
    .line 4344
    const-string v4, "CMD_CLR_REQUESTED is sent"
...
.method private updateFailureCause(ILandroid/net/NetworkCapabilities;Landroid/net/NetworkInfo;)V
    .locals 4
    .param p1, "networkType"    # I
    ...
    .line 5322
    :cond_0
    invoke-direct {p0, p3}, Lcom/android/server/ConnectivityService;->getFailureCause(Landroid/net/NetworkInfo;)I
    ...
    sput v1, Lcom/android/server/ConnectivityService;->sCurrentRadioType:I
    ...
    const-string v2, "updateFailureCause:"
    ...
    .line 5331
    .restart local v0    # "wifiInfo":Landroid/net/NetworkInfo;
    :cond_3
...
.method private updateNetworkInfo(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkInfo;)V
    ...
    iput-boolean v10, v6, Landroid/net/NetworkMisc;->explicitlySelected:Z
    ...
    .line 4691
    iget-object v6, v4, Lcom/android/server/connectivity/NetworkAgentInfo;->networkMisc:Landroid/net/NetworkMisc;
    ...
    .line 4696
    :cond_c
    sget v6, Lcom/android/server/ConnectivityService;->sCurrentRadioType:I
    ...
    invoke-direct {p0, v6, v10}, Lcom/android/server/ConnectivityService;->evalHandoverRequest(ILjava/lang/String;)Z
    :try_end_4
