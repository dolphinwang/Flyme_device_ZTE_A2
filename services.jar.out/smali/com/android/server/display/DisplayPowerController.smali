...
.field private static final COLOR_FADE_ON_ANIMATION_DURATION_MILLIS:I = 0x96

.field private static DEBUG:Z = false

.field private static final DEBUG_PRETEND_PROXIMITY_SENSOR_ABSENT:Z = false

.field private static final HALL_NEGATIVE:I = 0x0

.field private static final HALL_POSITIVE:I = 0x1

.field private static final HALL_UNKNOWN:I = -0x1
...
.field private final mOnHallNegativeRunnable:Ljava/lang/Runnable;

.field private final mOnHallPositiveRunnable:Ljava/lang/Runnable;
...
.method public constructor <init>(Landroid/content/Context;Landroid/hardware/display/DisplayManagerInternal$DisplayPowerCallbacks;Landroid/os/Handler;Landroid/hardware/SensorManager;Lcom/android/server/display/DisplayBlanker;)V
    ...
    iput v2, v0, Lcom/android/server/display/DisplayPowerController;->mHall:I
    ...
    iput-object v2, v0, Lcom/android/server/display/DisplayPowerController;->mOnHallPositiveRunnable:Ljava/lang/Runnable;
    ...
    iput-object v2, v0, Lcom/android/server/display/DisplayPowerController;->mOnHallNegativeRunnable:Ljava/lang/Runnable;
    ...
    invoke-direct {v2, v0}, Lcom/android/server/display/DisplayPowerController$12;-><init>(Lcom/android/server/display/DisplayPowerController;)V
    ...
    iget-object v2, v0, Lcom/android/server/display/DisplayPowerController;->mHallSensor:Landroid/hardware/Sensor;
    ...
    const-string v3, "getDefaultSensor mHallSensor"
    ...
    invoke-direct {v0, v2}, Lcom/android/server/display/DisplayPowerController;->setHallSensorEnabled(Z)V
...
.method private handleHallSensorEvent(JZ)V
    ...
    .line 1180
    iget v0, p0, Lcom/android/server/display/DisplayPowerController;->mHall:I

    if-eq v0, v1, :cond_0

    .line 1182
    iput v1, p0, Lcom/android/server/display/DisplayPowerController;->mHall:I

    .line 1183
    invoke-direct {p0}, Lcom/android/server/display/DisplayPowerController;->sendOnHallPositive()V
    ...
    iput v0, p0, Lcom/android/server/display/DisplayPowerController;->mHall:I

    .line 1190
    invoke-direct {p0}, Lcom/android/server/display/DisplayPowerController;->sendOnHallNegative()V
...
.method private sendOnHallNegative()V
    .locals 2
    ...
    iget-object v1, p0, Lcom/android/server/display/DisplayPowerController;->mOnHallNegativeRunnable:Ljava/lang/Runnable;
...
.method private sendOnHallPositive()V
    .locals 2
    ...
    iget-object v1, p0, Lcom/android/server/display/DisplayPowerController;->mOnHallPositiveRunnable:Ljava/lang/Runnable;
...
.method public isHallSensorAvailable()Z
    .locals 2

    .prologue
    .line 479
    iget-object v0, p0, Lcom/android/server/display/DisplayPowerController;->mHallSensor:Landroid/hardware/Sensor;
    ...
    const-string v1, "mHallSensor != null"
