...
.method public run()V
    ...
    invoke-static {v3}, Lcom/android/server/display/WifiDisplayController;->access$10300(Lcom/android/server/display/WifiDisplayController;)Landroid/net/wifi/p2p/WifiP2pDevice;
    ...
    # getter for: Lcom/android/server/display/WifiDisplayController;->mReConnectDevice:Landroid/net/wifi/p2p/WifiP2pDevice;
    invoke-static {v4}, Lcom/android/server/display/WifiDisplayController;->access$10300(Lcom/android/server/display/WifiDisplayController;)Landroid/net/wifi/p2p/WifiP2pDevice;
    ...
    invoke-static {v3, v6}, Lcom/android/server/display/WifiDisplayController;->access$10402(Lcom/android/server/display/WifiDisplayController;Z)Z
    ...
    invoke-static {v3, v4}, Lcom/android/server/display/WifiDisplayController;->access$10502(Lcom/android/server/display/WifiDisplayController;Z)Z

    .line 3849
    iget-object v3, p0, Lcom/android/server/display/WifiDisplayController$32;->this$0:Lcom/android/server/display/WifiDisplayController;

    # invokes: Lcom/android/server/display/WifiDisplayController;->connect(Landroid/net/wifi/p2p/WifiP2pDevice;)V
    invoke-static {v3, v0}, Lcom/android/server/display/WifiDisplayController;->access$10600(Lcom/android/server/display/WifiDisplayController;Landroid/net/wifi/p2p/WifiP2pDevice;)V
    ...
    invoke-static {v4}, Lcom/android/server/display/WifiDisplayController;->access$10700(Lcom/android/server/display/WifiDisplayController;)I
    ...
    invoke-static {v3, v4}, Lcom/android/server/display/WifiDisplayController;->access$10702(Lcom/android/server/display/WifiDisplayController;I)I

    .line 3856
    iget-object v3, p0, Lcom/android/server/display/WifiDisplayController$32;->this$0:Lcom/android/server/display/WifiDisplayController;

    # getter for: Lcom/android/server/display/WifiDisplayController;->mReConnection_Timeout_Remain_Seconds:I
    invoke-static {v3}, Lcom/android/server/display/WifiDisplayController;->access$10700(Lcom/android/server/display/WifiDisplayController;)I
    ...
    # getter for: Lcom/android/server/display/WifiDisplayController;->mReConnection_Timeout_Remain_Seconds:I
    invoke-static {v5}, Lcom/android/server/display/WifiDisplayController;->access$10700(Lcom/android/server/display/WifiDisplayController;)I
    ...
    invoke-static {v4}, Lcom/android/server/display/WifiDisplayController;->access$10800(Lcom/android/server/display/WifiDisplayController;)Ljava/lang/Runnable;
    ...
    invoke-static {v3}, Lcom/android/server/display/WifiDisplayController;->access$8500(Lcom/android/server/display/WifiDisplayController;)Landroid/content/Context;
    ...
    invoke-static {v3}, Lcom/android/server/display/WifiDisplayController;->access$10900(Lcom/android/server/display/WifiDisplayController;)V
