...
.method bindServiceLocked(Landroid/app/IApplicationThread;Landroid/os/IBinder;Landroid/content/Intent;Ljava/lang/String;Landroid/app/IServiceConnection;II)I
    ...
    .line 765
    .local v17, "clsname":Ljava/lang/String;
    :goto_1
    if-eqz v17, :cond_3
    ...
    .line 948
    .end local v17    # "clsname":Ljava/lang/String;
    ...
    .line 828
    .local v24, "s":Lcom/android/server/am/ServiceRecord;
    ...
    .line 843
    invoke-virtual/range {v24 .. v24}, Lcom/android/server/am/ServiceRecord;->getTracker()Lcom/android/internal/app/ProcessStats$ServiceState;

    move-result-object v25

    .line 844
    .local v25, "stracker":Lcom/android/internal/app/ProcessStats$ServiceState;
    if-eqz v25, :cond_c
    ...
    .line 851
    .end local v25    # "stracker":Lcom/android/internal/app/ProcessStats$ServiceState;
    :cond_c
    move-object/from16 v0, p0
    ...
    .end local v24    # "s":Lcom/android/server/am/ServiceRecord;
    :catch_2
    move-exception v4
...
.method startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;III)Landroid/content/ComponentName;
    ...
    .line 333
    .local v20, "callingPackages":[Ljava/lang/String;
    const/16 v19, 0x0

    .line 334
    .local v19, "callingPackage":Ljava/lang/String;
    invoke-static/range {v20 .. v20}, Lcom/android/internal/util/ArrayUtils;->isEmpty([Ljava/lang/Object;)Z
    ...
    .restart local v20    # "callingPackages":[Ljava/lang/String;
    ...
    .line 451
    invoke-virtual/range {v27 .. v27}, Lcom/android/server/am/ProcessRecord;->makeAdjReason()Ljava/lang/String;
