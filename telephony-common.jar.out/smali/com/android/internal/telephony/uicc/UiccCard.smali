...
.method private unRegisterProcess()V
    .locals 3
    ...
    .line 1296
    const-string v0, "unRegisterProcess"
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/uicc/IccRecords;->unregisterForImsiReady(Landroid/os/Handler;)V

    .line 1300
    iput-boolean v2, p0, Lcom/android/internal/telephony/uicc/UiccCard;->mCsimRigisterDone:Z

    .line 1301
    const-string v0, "unRegisterProcess: csim unregisterForImsiReady"
    ...
    .line 1306
    const-string v0, "unRegisterProcess: usim unregisterForImsiReady"
...
.method public preUpdate(ZLcom/android/internal/telephony/CommandsInterface;)V
    .locals 4
    .param p1, "isSvlte"    # Z
    .param p2, "svlteCi"    # Lcom/android/internal/telephony/CommandsInterface;
    ...
    const-string v2, "preUpdate, mIsSvlte ="

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-boolean v2, p0, Lcom/android/internal/telephony/uicc/UiccCard;->mIsSvlte:Z
    ...
    const-string v2, "preUpdate, Start: mSvlteCi = "

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v0, p0, Lcom/android/internal/telephony/uicc/UiccCard;->mSvlteCi:Lcom/android/internal/telephony/CommandsInterface;
    ...
    .line 1276
    iput-object p2, p0, Lcom/android/internal/telephony/uicc/UiccCard;->mSvlteCi:Lcom/android/internal/telephony/CommandsInterface;
    ...
    invoke-interface {v0, v2, v3, v1}, Lcom/android/internal/telephony/CommandsInterface;->registerForCdmaCardType(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v2, v3, v1}, Lcom/android/internal/telephony/uicc/UiccController;->registerForC2KWPCardTypeReady(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 1279
    invoke-direct {p0}, Lcom/android/internal/telephony/uicc/UiccCard;->unRegisterProcess()V
    ...
    const-string v2, "preUpdate, End: mSvlteCi = "

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-object v2, p0, Lcom/android/internal/telephony/uicc/UiccCard;->mSvlteCi:Lcom/android/internal/telephony/CommandsInterface;
    ...
    .line 1282
    iput-object v1, p0, Lcom/android/internal/telephony/uicc/UiccCard;->mSvlteCi:Lcom/android/internal/telephony/CommandsInterface;
    ...
    invoke-interface {v0, v2}, Lcom/android/internal/telephony/CommandsInterface;->unregisterForCdmaCardType(Landroid/os/Handler;)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/internal/telephony/uicc/UiccController;->unregisterForC2KWPCardTypeReady(Landroid/os/Handler;)V
...
.method public update(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/uicc/IccCardStatus;)V
    ...
    iget v7, p0, Lcom/android/internal/telephony/uicc/UiccCard;->mPhoneId:I

    invoke-virtual {v5, v7}, Lcom/mediatek/internal/telephony/uicc/SvlteUiccUtils;->isUsimWithCsim(I)Z
    ...
    const-string v7, "reset mImsSubscriptionAppIndex:"
