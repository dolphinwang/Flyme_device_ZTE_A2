...
.method static floatRangeCheck(F)Z
    ...
    .prologue
    .line 714
    const v0, -0x34fffffe    # -8388610.0f

    cmpl-float v0, p0, v0

    if-lez v0, :cond_0

    const v0, 0x4afffffc    # 8388606.0f
...
.method private static intToSint(II)[B
    ...
    .line 474
    const-string v1, "FormatUtils"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "Impossible case!! intToSint("
...
.method private static intToUint(II)[B
    ...
    const-string v3, "Impossible case!! intToUint("
...
.method static sfloatRangeCheck(F)Z
    ...
    .prologue
    .line 707
    const v0, -0x3affe000    # -2050.0f

    cmpl-float v0, p0, v0

    if-lez v0, :cond_0

    const v0, 0x44ffc000    # 2046.0f
...
.method private static sintToInt([BI)I
    ...
    const-string v3, "Impossible case!! sintToInt(), sintSize="
...
.method private static uintToInt([BI)I
    ...
    const-string v3, "Impossible case!! uintToInt(), uintSize="
...
.method private static uintToLong([BI)J
    ...
    .line 326
    const-string v2, "FormatUtils"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "Impossible case!! uintToLong(), uintSize="
